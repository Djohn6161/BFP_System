    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header pt-4 px-4 pb-1">
                <h3 class="modal-title fw-bolder text-primary">{{ $spot->investigation->subject }} (SPOT PROGRESS) </h3>
            ...
            <div class="modal-body pt-4 px-4 pt-0">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="2">{{ $investigation->alarmed != null ? $spot->alarmed->name : "Unknown" }}</td>
                    </tr>
                </table>
                <hr>
