<div class="modal fade" tabindex="-1" id="viewFinalProgressModal{{ $investigation->investigation_id }}">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header pt-4 px-4 pb-1">
                <h3 class="modal-title fw-bolder text-primary">Investigation Subject (PROGRESS FINAL)</h3>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                    data-bs-target="#viewProgressModal{{ $investigation->investigation_id }}"><span><i
