                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td class="text-break">{{$log->investigation->id}} - @if ($log->investigation->spot)
                            ...
                            Minimal<div class="modal fade" tabindex="-1" id="viewInvestigationLogs{{ $log->id }}">
                                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header pt-4 px-4 pb-1">
                                            <h4 class="modal-title fw-bolder text-primary">Investigation</h4>
                                        ...
                                        <div class="modal-body px-4 py-3">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-break">{{ $log->investigation != null ? $log->investigation->date : 'Unavailable' }}</td>
                                                </tr>
                                            </table>
                                            <hr>
