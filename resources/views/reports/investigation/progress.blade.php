    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb" class="p-2 fw-bolder">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Progress Investigation Reports</li>
            </ol>
        </nav>
        <div class="col-lg-12">
            <div class="row">
                                    ...
                                    <tbody>
                                        @php
                                            $sortedInvestigations = $investigations->sortByDesc(function (
                                                ...
                                                return \Carbon\Carbon::parse($investigation->investigation->created_at);
                                            });
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                @if ($user->privilege == 'investigation_admin_chief' || $user->privilege == 'investigation_clerk')
                                                    <td>
                                                        ...
                                                        <x-reports.Investigation.view-progress :investigation=$investigation
                                                            :responses=$responses
