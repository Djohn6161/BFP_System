                    ...
                    <form>
                        ...
                        <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" placeholder="Eg. 06 March 2024 2300h" class="form-control"
                                    id="dateTime" required>
                            </div>
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <input type="text" placeholder=" Eg. Ligao" class="form-control" id="municipality"
                                    required>
                            </div>
                            <div class="col-lg-3 mb-4">
                                <label for="barangay" class="form-label">Barangay</label>
                                <input type="text" placeholder=" Eg. Sta. Cruz" class="form-control" id="barangay"
                                    required>
                            </div>
                            <div class="col-lg-3 mb-4">
                                <label for="other" class="form-label">Other Location</label>
                                <input type="text" placeholder=" Eg. Camarines Sur" class="form-control"
                                    id="other" required>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="officeAddress" class="form-label">Involved Property/Establishment</label>
                                <input type="text" placeholder=" Eg. Vacant Lot " class="form-control" id="province"
                                    required>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="officeAddress" class="form-label">Property Data</label>
                                <input type="text" placeholder=" Eg. Juan Dela Cruz" class="form-control"
                        ...
                        <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                            <div class="row m-0 p-0 second-div border-0">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="number" placeholder="Eg. 09xxxxxxxxx" class="form-control"
                                        id="telephone" required>
                                </div>
                                <div class="col-lg-12 mb-12 p-2 mb-3">
                                    <label for="chief" class="form-label">Notification Originator</label>
                                    <input type="text" placeholder="Eg. Chief Operation" class="form-control"
                                        id="chief" required>
                                </div>
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" placeholder="Eg. 1900h" class="form-control"
                                        id="timeReturnedInput" required>
                                </div>
                                <div class="col-lg-4 mb-3">
                        ...
                        <div class="row border border-light-subtle shadow rounded my-3 p-4">
                            ...
                            <div class="row time-alarm-status-declared-div m-0 p-0">
                                <div class="col-lg-6 mb-6">
                                    <label for="timeAlarmStatusDeclared" class="form-label">Owner of
                                ...
                                <div class="col-lg-6 mb-6">
                                    <label for="timeAlarmStatusDeclaredTime" class="form-label">Occupant of
                                        Property/Establishment</label>
