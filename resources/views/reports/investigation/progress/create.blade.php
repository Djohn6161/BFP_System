                      ...
                      <x-reports.investigation.memo-investigate :spot=$spot ></x-reports.investigation.memo-investigate>
                        ...
                        <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                            ...
                            <div class="col-lg-12 mb-12 pb-3 mb-3">
                                <label for="authority" class="form-label"><h3></h3></label>
                                <div>
                                    <div id="toolbar1">
                        ...
                        <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                            ...
                            {{-- <h5>Details</h5> --}}
                            <div class="col-lg-12 mb-12 pb-3 mb-3">
                                <label for="matters-investigated" class="form-label"><h3></h3></label>
                                <div>
                                    <div id="toolbar2">
                                        <span class="ql-formats">
                                            <select class="ql-font"></select>
                        ...
                        <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                            ...
                            {{-- <h5>Details</h5> --}}
                            <div class="col-lg-12 mb-12 pb-3 mb-3">
                                <label for="facts-of-the-case" class="form-label"><h3></h3></label>
                                <div>
                                    <div id="toolbar3">
                                        <span class="ql-formats">
                                            <select class="ql-font"></select>
