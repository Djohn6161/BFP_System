                                            ...
                                            <div class="row">
                                                <form>
                                                    <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="caller"
                                                                class="form-label">Caller/Reported/Transmitted by:</label>
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                                                        ...
                                                        <div class="row m-0 p-0">
                                                            <button type="button" id="addNewDivApor"
                                                                class="btn btn-primary">+ Add New Fire Engine
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded my-3 p-4">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="firstResponder" class="form-label">First
                                                                Responder</label>
                                                            <input type="text" placeholder="Enter responder"
                                                        ...
                                                        <div class="row time-alarm-status-declared-div m-0 p-0">
                                                            ...
                                                            <div class="col-lg-4 mb-3">
                                                                <label for="timeAlarmStatusDeclared"
                                                                    class="form-label">Alarm Status</label>
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded my-3 p-4">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="specifyTypeOfOccupancy"
                                                        ...
                                                        <hr>
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="approxDistanceFireIncident"
                                                                class="form-label">Approximate Distance of Fire
                                                                Incident from Fire Station (Km)</label>
                                                            <input type="text" placeholder="eg. 1.5Km"
                                                                class="form-control" id="firstResponderInput">
                                                        </div>
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="deneralDescriptionStructureInvolved"
                                                                class="form-label">General Description of
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded my-3 p-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="row">
                                                                <h5>Civilian</h5>
                                                                <div class="col-lg-6 mb-3">
                                                                    <label for="civilianInjured"
                                                                        class="form-label">Injured</label>
                                                                    <input type="number" placeholder="No. of injured"
                                                                        class="form-control" id="firstResponderInput">
                                                                </div>
                                                                <div class="col-lg-6 mb-3">
                                                                    <label for="civilianDeath"
                                                                        class="form-label">Death</label>
                                                                    <input type="number" placeholder="No. of deaths"
                                                                        class="form-control" id="firstResponderInput">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded my-3 p-4">
                                                        ...
                                                        <h3 class="border-bottom border-4 border-secondary pb-2 mb-3">8,
                                                            10-12</h3>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            <label for="firefighterDeath" class="form-label">Type /
                                                                Kind</label>
                                                            <input type="text" placeholder="Type / kind"
                                                                class="form-control" id="firstResponderInput">
                                                        </div>
                                                        <div class="col-lg-4 mb-3">
                                                            <label for="firefighterDeath" class="form-label">Total
                                                                ft.</label>
                                                            <input type="number" placeholder="Enter total feet"
                                                                class="form-control" id="firstResponderInput">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row border border-light-subtle shadow rounded my-3 p-4">
                                                        ...
                                                        <div class="row m-0 p-0">
                                                            <button type="button" id="addNewDutyPersonnelAtFireScene"
                                                                class="btn btn-primary">+ Add another duty
                                                                personnel</button>
                                                        </div>
                                                    </div>
