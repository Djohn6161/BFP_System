                    ...
                    <form action="{{route('report.store', ['category' => $category])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row" >
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" placeholder="Enter Incident Name" class="form-control" id="name" name="name">
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3 form-check ps-3">
                                ...
                                <input name="time_of_departure" type="datetime-local" class="form-control" id="exampleCheck1">
                            ...
                            <div class="col-lg-6 mb-3 form-check">
                                ...
                                <input name="time_of_arrival_to_scene" type="datetime-local" class="form-control" id="exampleCheck1">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="drivers_id">
                                    ...
                                    @foreach ($personnels as $driver)
                                        <option value="{{$driver->id}}">{{$driver->rank->slug . " " . $driver->last_name}}</option>
                                    @endforeach
                                </select>
                                @error('drivers_id')
                                <div class="text-danger ps-3" role="">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="team_leaders_id">
                                    ...
                                    @foreach ($personnels as $teamLeader)
                                        <option value="{{$teamLeader->id}}">{{$teamLeader->rank->slug . " " . $teamLeader->last_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" placeholder="Enter Street name" class="form-control" id="street" name="street">
                                @error('street')
                                <div class="text-danger ps-3" role="">
                                    {{$message}}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" placeholder="Outside Area of Responsibility" class="form-control" name="otherLocation" id="otherLocation">
                                @error('otherLocation')
                                <div class="text-danger ps-3" role="">
                                    {{$message}}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="number_of_victims" name="number_of_victims">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="number" placeholder="ex. 1000" class="form-control" id="estimate_cost_of_damages" name="estimate_cost_of_damages">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3 form-check ps-3">
                                ...
                                <input type="datetime-local" class="form-control" id="time_of_arrival_to_station" name="time_of_arrival_to_station">
