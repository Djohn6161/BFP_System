                    ...
                    <div class="accordion accordion-flush" id="accordionExample">
                        <div class="accordion-item p-0">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show"
                                ...
                                <a href="{{route('user.Response.index')}}" class="sidebar-link accordion-body ms-2 reports-collapse {{$active == 'response' ? 'active' : ''}}" href="{{route(auth()->user()->type . '.dashboard')}}">
                                    Response
                                </a>
                                <a href="{{route('user.nonResponse.index')}}" class="sidebar-link accordion-body ms-2 reports-collapse">
                                    Non Response
                                </a>
                            </div>
                        </div>
