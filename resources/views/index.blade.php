...
<body
    style="background-image: url('../assets/images/backgrounds/b.jpg'); background-size: cover; background-position: center;">
    <!--  Body Wrapper -->
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('login') }}" id="loginForm">
                                ...
                                <button type="submit" id="submitBtn"
                                    class="btn btn-dark w-100 py-8 fs-4 mb-4 rounded-2">Sign
                                    In</button>
                            </form>
                        </div>
                    </div>
