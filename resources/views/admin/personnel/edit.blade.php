                    ...
                    <div class="row border border-light-subtle shadow rounded p-4 mb-4 bg-white">
                        ...
                        <div class="col-lg-4">
                            <div class="col-lg-12 mb-3">
                                <img id="personnel-picture" src="/assets/images/personnel_images/{{ $personnel->picture }}" class="object-fit-cover img-fluid w-100" style="height: 340px;" alt="Personnel Picture">
                                <div class="row px-2">
                                    ...
                                    <input type="file" id="photo-upload" style="display: none;" accept="image/*" onchange="previewPhoto(event)" name="image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" placeholder="Enter account number" class="form-control" id="accountNumber" name="account_number" value="{{ $personnel->account_number }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <label for="itemNumber" class="form-label">Item Number</label>
                                    <input type="text" placeholder="Enter item number" class="form-control" id="itemNumber" name="item_number" value="{{ $personnel->item_number }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" placeholder="First Name" class="form-control" id="firstName" name="first_name" value="{{ $personnel->first_name }}">
                                    </div>
                                    <div class="col-lg-3">
                                        <label class="form-label">Middle Name</label>
                                        <input type="text" placeholder="Middle Name" class="form-control" id="middleName" name="middle_name" value="{{ $personnel->middle_name }}">
                                    </div>
                                    <div class="col-lg-3">
                                        <label class="form-label">Last Name</label>
                                        <input type="text" placeholder="Last Name" class="form-control" id="lastName" name="last_name" value="{{ $personnel->last_name }}">
                                    </div>
                                    <div class="col-lg-3">
                                        <label class="form-label">Suffix Name</label>
                                        <input type="text" placeholder="Suffix Name" class="form-control" id="suffixName" name="extension" value="{{ $personnel->extension }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" placeholder="Enter contact number" class="form-control" id="contactNumber" name="emergency_contact_number" value="{{ $personnel->emergency_contact_number }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <label for="dateOfBirth" class="form-label">Date of Birth</label>
                                    <input type="date" class="form-control" id="dateOfBirth" name="date_of_birth" value="{{ $personnel->date_of_birth }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                            ...
                            <div class="row m-0 p-0" id="editTertiaryCourseContainer">
                                ...
                                <div class="col-lg-12 px-0 mb-2">
                                    <div class="input-group mb-1">
                                        <input type="text" placeholder="Enter tertiary course/s" class="form-control" id="tertiaryCourses" name="tertiary[]" value="{{ $tertiary->name }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="row m-0 p-0" id="editPostGraduateCoursesContainer">
                                ...
                                <div class="col-lg-12 px-0 mb-2">
                                    <div class="input-group mb-1">
                                        <input type="text" placeholder="Enter post graduate course/s" class="form-control" id="postGraduateCourses" name="courses[]" value="{{ $course->name }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter highest eligibility" class="form-control" id="highestEligibility" value="{{ $personnel->highest_eligibility }}" name="highest_eligibility">
                        </div>
                        <div class="col-lg-6 mb-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" id="pagibig" name="pagibig" value="{{ $personnel->pagibig }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="row m-0 p-0 designationContainer">
                                <div class="col-lg-12 px-0">
                                    <div class="row m-0 p-0">
                                        <div class="col-lg-6 m-0 p-0">
                                            ...
                                            <button type="button" class="btn btn-sm btn-primary mb-1 addPersonnelDesignationEdit">+
                                                ADD</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3 ps-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class=" ms-1 btn btn-outline-danger remove-edit-personnel-designation">x</button>
                                    </div>
                                </div>
                                @endforeach
