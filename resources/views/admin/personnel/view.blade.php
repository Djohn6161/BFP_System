            ...
            <div class="row">
                <div class="row border border-light-subtle shadow rounded p-4 mb-4 bg-white">
                    <div class="col d-flex justify-content-end mb-2">
                        ...
                        <button type="button" class="btn btn-danger me-2" data-bs-toggle="modal" disabled> <i class="ti ti-x"></i> Invalid</button>
                        @else
                        <button type="button" class="btn btn-danger me-2" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="ti ti-trash"></i> Delete</button>
                        @endif
                        <a href="{{ route('admin.personnel.update.form', $personnel->id) }}" class="btn btn-primary">Update Information</a>
                    </div>
                    <h3 class="border-bottom border-4 border-secondary pb-2 mb-3">Personal Details</h3>
                    <div class="col-lg-4">
                        <div class="col-lg-12 mb-3">
                            <img id="personnel-picture" src="/assets/images/personnel_images/{{ $personnel->picture }}" class="object-fit-cover img-fluid" style="width: 300px; height: 400px;" alt="Personnel Picture">
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" placeholder="Enter account number" class="form-control" id="accountNumber" readonly value="{{ $personnel->account_number }}">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="itemNumber" class="form-label">Item Number</label>
                                <input type="text" class="form-control" id="itemNumber" readonly value="{{ $personnel->item_number }}">
                            </div>
                            <div class="col-lg-4 mb-3">
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" readonly value="{{ $personnel->first_name }}">
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Middle Name</label>
                                    <input type="text" placeholder="Middle Name" class="form-control" id="middleName" readonly value="{{ $personnel->middle_name }}">
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" placeholder="Last Name" class="form-control" id="lastName" readonly value="{{ $personnel->last_name }}">
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-label">Suffix Name</label>
                                    <input type="text" placeholder="Suffix Name" class="form-control" id="suffixName" readonly value="{{ $personnel->extension }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" placeholder="Enter contact number" class="form-control" id="contactNumber" readonly value="{{ $personnel->contact_number }}">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="contactNumber" class="form-label">Emergency Contact Number</label>
                                <input type="text" placeholder="Enter contact number" class="form-control" id="contactNumber" readonly value="{{ $personnel->emergency_contact_number }}">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="dateOfBirth" class="form-label">Date of Birth</label>
                                <input type="date" class="form-control" id="dateOfBirth" readonly value="{{ \Carbon\Carbon::parse($personnel->date_of_birth)->format('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="religion" readonly value="{{ $personnel->religion }}">
                            </div>
                        </div>

                        <div class="col-lg-12 mb-3">
                            <label for="completeAddress" class="form-label">Complete Address</label>
                            <input type="text" placeholder="Enter complete address" class="form-control" id="completeAddress" readonly value="{{ $personnel->address }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Enter tertiary course/s" class="form-control" id="tertiaryCourses" readonly value="{{ $tertiary->name }}">
                        @endforeach
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control" type="text" id="tin" placeholder="XXX-XXX-XXX" readonly value="{{$personnel->tin}}">
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Enter mode of entry" class="form-control" id="modeOfEntry" readonly value="{{$personnel->mode_of_entry}}">
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="file-item d-flex justify-content-between align-items-center mb-1">
                        ...
                        @if ($file != '')
                        <span>{{ $file }}</span>
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#filePreviewPersonnelModal" data-file="{{ $file }}">Preview</a>
                        @endif
                        @endforeach
                    </div>
                    <hr>
