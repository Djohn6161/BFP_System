            ...
            <div class="col-lg-11 p-4">
                <div class="row">
                    <div class="row border border-light-subtle shadow rounded p-4 mb-4 bg-white">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" placeholder="Enter contact number" class="form-control"
                                        id="contactNumber" readonly value="{{ $personnel->emergency_contact_number }}">
                                </div>
                                <div class="col-lg-4 mb-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            @foreach ($personnel->courses as $course)
                                <input type="text" placeholder="Enter post graduate course/s" class="form-control"
                                    id="postGraduateCourses" readonly value="{{ $course->name }}">
                            @endforeach
                        ...
                        <div class="file-item row justify-content-between align-items-center mb-1">
                            @foreach ($files as $file)
                                @if ($file != '')
                                    <div class="col-md-6 col-lg-4">
                                        <h6 class="me-3">File {{ $loop->index }}</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filePreviewPersonnelModal').on('show.bs.modal', function(event) {
                ...
                var modal = $(this);
                var iframeSrc = "{{ asset('personnel_files/') }}" + '/' + file;
