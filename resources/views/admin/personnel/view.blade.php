                    ...
                    <div class="row border border-light-subtle shadow rounded p-4 mb-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <select class="form-select" id="maritalStatus" name="marital_status" readonly>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            @foreach ($courses as $course)
                                <input type="text" placeholder="Enter post graduate course/s"
                                    class="form-control mb-2" id="postGraduateCourses" readonly
                                    value="{{ $course->name }}">
                            @endforeach
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter highest training" class="form-control"
                                id="highestTraining" readonly value="{{ $personnel->highest_training }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter specialized training" class="form-control"
                                id="specializedTraining" readonly value="{{ $personnel->specialized_training }}">
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" id="philhealth" placeholder="XX-XXXXXXXXX-X"
                                readonly value="{{ $personnel->philhealth }}">
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="dateEnteredFireService" readonly
                                value="{{ $personnel->date_entered_fire_service }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="dateOfLastPromotion" readonly
                                value="{{ $personnel->last_date_promotion }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter appointment status" class="form-control"
                                id="appointmentStatus" readonly value="{{ $personnel->appointment_status }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter unit code" class="form-control" id="unitCode"
                                readonly value="{{ $personnel->unit_code }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" placeholder="Enter unit assignment" class="form-control"
                                id="unitAssignment" readonly value="{{ $personnel->unit_assignment }}">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label for="designation" class="form-label">Designation</label>
                            <input type="text" placeholder="Enter designation" class="form-control" id="designation"
                                readonly value="{{ $personnel->designation }}">
                        </div>
                        <div class="col-lg-12 mb-3">
                        ...
                        <div class="file-item d-flex justify-content-between align-items-center mb-1">
                            ...
                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#filePreviewPersonnelModal"
                                data-files="{{ $personnel->files }}">Preview</a>
                        </div>
                        <hr>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filePreviewPersonnelModal').on('show.bs.modal', function(event) {
                ...
                var modal = $(this);
                console.log(files);
                modal.find('#text').val(files);
                // Update other modal fields similarly
            });
        });
    </script>
    <x-personnel.preview :category="$active" :files="$files"> </x-personnel.preview>
