...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addOtherDesignationModal">Add Designation</button>
                            </div>
                                ...
                                <table class="table mb-0 align-middle w-100" id="designationTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-25">
                                                <button type="button" class="btn btn-success w-100 mb-1" data-bs-toggle="modal" data-bs-target="#editOtherDesignationModal">Update</button>
                                                <br>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteOtherDesignationModal"
                    ...
                    <div class="card w-100">
                        <div class="card-body p-4">
                            ...
                            <!-- Display Total Personnel -->
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="fw-semibold text-center">C, Operation Section
                                    <span class=" ms-3 badge rounded-pill bg-secondary"></span>
                                </h5>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#addUnitModal">Add Unit</button></li>
                                        <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editSectionModal">Edit Section</button></li>
                                        <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteSectionModal">Delete Section</button></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <table class="table mb-0 align-middle w-100" id="designationTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>designation name</td>
                                            <td class="w-25">
                                                <button type="button" class="btn btn-success w-100 mb-1"data-bs-toggle="modal" data-bs-target="#editUnitModal">Update</button>
                                                <br>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUnitModal"
                                                    class="btn btn-danger hide-menu w-100 mb-1">Delete</button>
                                            </td>
                                            {{-- <td>{{ $designation->class }}</td> --}}
                                            {{-- <td>{{ substr(App\Models\Designation::find($designation->section)->name, 0, 3) ?? 'Unspecified' }}</td> --}}
    ...
    <x-designation.other.edit-other></x-designation.other.edit-other>
    <x-designation.other.delete-other></x-designation.other.delete-other>
