                                            ...
                                            <tr>
                                                ...
                                                <td class="w-25 py-2">
                                                    <div class="d-flex flex-row">
                                                        <div class="me-1">
                                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editOtherDesignationModal{{ $item->id }}">Update</button>
                                                        </div>
                                                        <div>
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#deleteOtherDesignationModal{{ $item->id }}" class="btn btn-danger hide-menu">Delete</button>
                                                        </div>
                                                    </div>
                                                ...
                                                @foreach ($designations->where('section', $section->id) as $item)
                                                    <tr>
                                                        ...
                                                        <td class="w-25 py-2">
                                                            <div class="d-flex flex-row">
                                                                <div class="me-1">
                                                                    <button type="button" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#editUnitModal{{ $item->id }}">Update</button>
                                                                </div>
                                                                <div>
                                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUnitModal{{ $item->id }}" class="btn btn-danger hide-menu w-100">Delete</button>
                                                                </div>
                                                            </div>
