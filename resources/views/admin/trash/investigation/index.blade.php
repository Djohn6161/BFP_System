                                ...
                                <table class="table mb-0 align-middle w-100" id="trashInvestigationTable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($investigations as $investigation)
                                            ...
                                            <x-trash.investigation.restore :investigation=$investigation></x-trash.investigation.restore>
                                            <tr class="text-center">
                                                {{-- {{dd($investigation)}} --}}
                                                ...
                                                <td class="border-bottom-0">
                                                    ...
                                                    <button type="button"  data-bs-toggle="modal"
                                                        ...
                                                        <x-trash.investigation.delete :investigation=$investigation></x-trash.investigation.delete>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
