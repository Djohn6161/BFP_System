                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 mb-6">
                                        ...
                                        <input type="text" class="form-control" name="acronym" value="{{ $station->acronym }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 mb-6">
                                        <label for="caseNumberTemp" class="form-label">Case Number Template</label>
                                        <input type="text" class="form-control" name="caseNumberTemp" value="{{ $station->caseNumberTemp }}">
                                    </div>
                                    <div class="col-lg-6 mb-6">
                                        <label for="blotterNumberTemp" class="form-label">Blotter Number Template</label>
                                        <input type="text" class="form-control" name="blotterNumberTemp" value="{{ $station->blotterNumberTemp }}">
                                    </div>
                                </div>
