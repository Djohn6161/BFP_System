...
class InvestigationController extends Controller
{
    ...
    public function storeSpot(Request $request)
    {
        ...
        $log->save();
        return redirect("reports/investigation/index")->with("success", "Investigation Created Successfully!");
    }
    ...
    public function updateMinimal(Request $request, Minimal $minimal)
    {
        ...
        $log->save();
        return redirect("reports/investigation/index")->with("success", $minimal->investigation->subject . " Updated Successfully!");
    }
    ...
    public function updateSpot(Request $request, Spot $spot)
    {
        ...
        if (auth()->user()->privilege == 'investigation_clerk') {
            ...
            if (!$passcodeStatus) {
                return redirect("reports/investigation/index")->with('status', "Passcode doesn't match.");
            }
            // dd($passcodeStatus, $passcode);
        }
        ...
        $log->save();
        return redirect("reports/investigation/index")->with("success", $spot->investigation->subject . " Updated Successfully!");
    }
    ...
    public function updateProgress(Request $request, Progress $progress)
    {
        ...
        $log->save();
        return redirect("reports/investigation/index")->with("success", $progress->investigation->subject . " Updated Successfully!");
    }
    ...
    public function updateFinal(Request $request, Ifinal $final)
    {
        ...
        $log->save();
        return redirect("reports/investigation/index")->with("success", $final->investigation->subject . " Updated Successfully!");
    }
